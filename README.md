...
- **MainLayout.razor (footer):** "Pedimiento" → debería ser "Pedimento".
...
## 6. RESÚMEN DE ACCIONES SUGERIDAS

| Prioridad | Acción |
|-----------|--------|
| Alta | Hash de contraseñas |
| Alta | Unificar sistemas de usuarios (Auth vs Usuarios) |
| Media | Unificar nombre de BD por defecto (`sdi_upm_db`) |
| Media | Corregir "Pedimiento" → "Pedimento" |
| Media | Quitar Weather.razor y Counter.razor si no se usan |
| Baja | Conectar COVE, Ferroviario, MV, VUCEM a BD en modo Host |
| Baja | Implementar o eliminar FocusOnNavigate |
| Baja | Sustituir Console.WriteLine por ILogger |
| Baja | Traducir mensaje de error en index.html |

---

*Reporte generado para el proyecto SDI UPM / SPI.Edu*
